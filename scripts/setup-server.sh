...
echo "       nano .env                 # completar HOST, DB_USERNAME, PASSWORD, DATABASE, DB_PORT, JWT_SECRET, COOKIE_KEY, EMAIL_*"
echo ""
echo "  2.1 frontend/.env:"
echo "       cd $DEPLOY_PATH/frontend"
echo "       printf 'VITE_BASE_URL=http://146.83.198.35:1207/api\n' > .env"
echo ""
