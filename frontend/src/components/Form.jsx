...
const Form = ({
    ...
    const hasConfirmPassword = flatFields.some((field) => field.name === 'confirmPassword');
    ...
    }, [hasConfirmPassword, trigger, watchedPassword]);
    ...
    const handleFileDrop = (field, event, registerProps) => {
        ...
        if (fileInputRefs.current[field.name]) {
            try {
                ...
                // Algunos navegadores no permiten asignar FileList al input; React Hook Form recibe el valor abajo.
            }
        }
        ...
        return (
            <div className="checkbox-field">
                <input
                    ...
                    defaultChecked={typeof field.checked === 'boolean' ? undefined : field.defaultChecked || false}
                    disabled={field.disabled}
