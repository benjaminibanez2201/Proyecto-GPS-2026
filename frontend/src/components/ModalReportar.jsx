...
import { crearReportePublicacion } from '@services/reportes.service.js';

const motivos = [
  { value: 'informacion_incorrecta', label: 'Información incorrecta' },
  { value: 'contenido_engañoso', label: 'Contenido engañoso' },
  { value: 'fraude_sospechoso', label: 'Sospecha de fraude' },
  { value: 'spam', label: 'Spam o contenido repetido' },
  { value: 'otro', label: 'Otro motivo' },
];

export default function ModalReportar({ publicacion, open, onClose, onSuccess }) {
  ...
  const tituloPublicacion = publicacion.titulo || 'esta publicación';
        ...
        <div style={styles.header}>
          <div style={styles.titleWrap}>
            <div style={styles.iconWrap}>
              <FlagTriangleRight size={22} strokeWidth={2.2} />
            </div>
            <div>
              <p style={styles.eyebrow}>Reportar publicación</p>
              <h2 style={styles.title}>Ayúdanos a revisar {tituloPublicacion}</h2>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <label style={styles.field}>
            ...
            <textarea
              ...
              placeholder="Describe brevemente por qué consideras que esta publicación debe revisarse"
              rows="4"
